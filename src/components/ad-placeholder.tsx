...
export function AdPlaceholder({ className, label = "Advertisement", variant, slotId }: AdPlaceholderProps) {
  ...
  return (
    <div 
      id={finalSlotId}
      className={cn(
        "ad-placeholder relative flex items-center justify-center border border-dashed border-border bg-muted/30 text-muted-foreground text-sm text-center rounded-md my-6 overflow-hidden transition-all", 

...
export default function ContactPage() {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:architect@inferenceroi.com?subject=${mailtoSubject}&body=${mailtoBody}`;
  };
    ...
    <div className="container mx-auto py-8 px-4 md:px-6">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl font-headline text-primary">
          Connect With InferenceROI
        </h1>
        <p className="mt-4 text-lg text-foreground/80 max-w-3xl mx-auto text-balance">
          Have questions about our ROI models or local AI infrastructure? Reach out to our engineering team for specialized support and inquiries.
        </p>
      </header>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        <Card className="shadow-lg">
          <CardHeader>
            <CardTitle className="text-2xl font-headline text-primary">TCO Inquiry Form</CardTitle>
            <CardDescription>Share your infrastructure questions or feedback. We typically respond within 24-48 hours.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="space-y-8">
            <Card className="shadow-lg">
                <CardHeader>
                    <CardTitle className="text-2xl font-headline text-primary">Infrastructure Support</CardTitle>
                     <CardDescription>Direct access to our TCO specialists.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="flex items-center gap-3">
                        <Mail className="h-6 w-6 text-primary" />
                        <a href="mailto:architect@inferenceroi.com" className="text-foreground/90 hover:text-primary">architect@inferenceroi.com</a>
                    </div>
                </CardContent>
            </Card>
